...
elaborate()
{
  xelab --relax --debug typical --mt auto -L noc_lib -L xil_defaultlib -L secureip -L xpm --snapshot demo_1_0 xil_defaultlib.demo_1_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim demo_1_0 -key {Behavioral:sim_1:Functional:demo_1_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb demo_1_0.wdb xsim.dir)
