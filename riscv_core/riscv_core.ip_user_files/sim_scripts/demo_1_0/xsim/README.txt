...
#
# Generated by export_simulation on Sun Jan 16 19:46:53 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './demo_1_0.sh' script.

./demo_1_0.sh -reset_run
...
./demo_1_0.sh -noclean_files

For more information on the script, please type './demo_1_0.sh -help'.
